...
open class RectMarker: MarkerImage
{
    ...
    public init(color: NSUIColor, font: NSUIFont, insets: UIEdgeInsets, miniTime: Double = 0.0, interval: Double = 0.0)
    {
        super.init()
...
//            context.setFillColor(color.cgColor)
            context.beginPath()
            drawRoundedRect(rect: rect, inContext: context, radius: 4.0, borderColor: UIColor.neutral400.cgColor, fillColor: UIColor.white.cgColor)
            context.fillPath()
        }
        label.draw(in: rect)
